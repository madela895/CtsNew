...
public abstract class Aplicant{
	...
	public void afiseazaStatutPeProiect(Proiect proiect){
		...
		stringBuiler.append("Aplicantul ").append(this.nume).append(" ").append(this.prenume);
		stringBuiler.append(punctaj>proiect.getPragAcceptare() ? "a fost acceptat" :" nu a fost acceptat" );
